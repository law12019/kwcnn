...
girder.views.HeatMapView = girder.View.extend({
    events: {
    ...
    _loadMissionData: function (mission_data) {
        ...
        this.sa_heatmap = new SA.HeatMap(this.sa_viewer.Div);
        ...
        this.sa_heatmap.Transform = transform;
        ...
        this.overlay_slider = $('<input type="range" min="0" max="100">')
            ...
            .on("input",
                _.bind(function () {
                    var v = parseFloat(this.overlay_slider.val()) / 50.0;
                    this.sa_heatmap.Gamma = v;
    ...
    _loadImageTileData: function (index,imageId,image_tile_data) {
        ...
        if (index == 0) {
            ...
            if (index > 0) {
                ...
                this.sa_heatmap.SetCache(cache);
                this.sa_viewer.AddLayer(this.sa_heatmap);
            }
        }
