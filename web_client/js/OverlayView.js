...
girder.views.OverlayView = girder.View.extend({
    events: {
    ...
    _loadMissionData: function (mission_data) {
        ...
        //this.sa_view_layer = new SA.OverlayView(this.sa_viewer.Div);
        //this.sa_viewer.AddLayer(this.sa_view_layer); 

        this.sa_overlay = new SA.OverlayView(this.sa_viewer.Div);
        ...
        this.sa_overlay.Transform = transform;
        ...
        this.overlay_slider = $('<input type="range" min="0" max="100">')
            ...
            .on('input',
                _.bind(function () {
                    var v = parseFloat(this.overlay_slider.val()) / 100.0;
                    this.sa_overlay.Opacity = v;
    ...
    _loadImageTileData: function (index,imageId,image_tile_data) {
        ...
        if (index == 0) {
            ...
            if (index > 0) {
                ...
                this.sa_overlay.SetCache(cache);
                this.sa_viewer.AddLayer(this.sa_overlay);
            }
        }
